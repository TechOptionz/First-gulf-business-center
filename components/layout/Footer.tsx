            ...
            <div className="pt-2">
              <div className="flex items-center gap-3">
                <a
                  ...
                  aria-label="Facebook"
                  className="w-11 h-11 rounded-sm bg-charcoal-900 border border-charcoal-700 flex items-center justify-center text-cream-200 hover:text-white hover:border-brass-400 transition-colors"
                >
